 ...
 *
 * 現地で「Yahoo天気の2週間予報が当たる」と言われるのは、Yahoo天気が
 * 日本気象協会・ウェザーマップ経由で気象庁の予報を配信しており、
 * そこに日本向けの統計補正がかかっているため。Yahoo 自体には予報の公開APIが無く
 * （YOLPの気象情報APIは前後1時間の降水強度のみ）、ページの取得は利用規約に反するので使わない。
 * 代わりに、その上流である気象庁の公式予報を直接取りにいく。
 *
