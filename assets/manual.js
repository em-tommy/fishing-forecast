...
(function (global) {
  ...
  function render(host, settings, period) {
    ...
    html.push(card('気象庁の公式予報（第2の意見）', '' +
      ...
      '<p class="sub">Yahoo天気や tenki.jp が配信しているのも、元をたどればこの気象庁の予報です。' +
      'Yahoo天気には予報の公開APIが無く、ページの自動取得は利用規約に反するため、上流を直接使っています。' +
      '画面下部にYahoo天気（上越市・津南町）へのリンクも置いてあります。</p>' +
